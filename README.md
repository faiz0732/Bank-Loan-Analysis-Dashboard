...
The project demonstrates a complete analytics workflow — from raw CSV data and SQL-based data preparation to interactive dashboards in Power BI — enabling data-driven decision-making for banking and financial institutions.
...
1. **Grade-based Risk Pattern:** Lower credit grades (E–G) show significantly higher default rates compared to higher-grade borrowers (A–B).
...
| Default Rate (%)      | Charged-off loans ÷ Total loans | Credit risk indicator |
...
***⭐ Skills Demonstrated:*** SQL, Data Cleaning, KPI Development, Power BI, Data Visualization, Credit Risk Analysis, Financial Analytics, Business Storytelling.
